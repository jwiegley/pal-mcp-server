...
class TestIntelligentFallback:
    ...
    def test_prefers_openai_gpt56_terra_when_available(self):
        """Test that GPT-5.6 Terra is the balanced OpenAI fallback."""
    ...
    def test_auto_mode_conversation_memory_integration(self):
        ...
        with (
            ...
            with patch("utils.model_context.ModelContext") as mock_context_class:
                ...
                # Verify that ModelContext uses the balanced GPT-5.6 Terra fallback.
